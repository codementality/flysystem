...
class FlysystemAdapterPluginManager extends DefaultPluginManager implements FallbackPluginManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin\Adapter', $namespaces, $module_handler, 'Drupal\flysystem\Plugin\FlysystemPluginInterface', 'Drupal\flysystem\Annotation\FlysystemAdapter');
